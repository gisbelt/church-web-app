     ...
     <!-- 4 -->
        ...
        <section class="report">
            <div class="report-header">
                ...
                <div class="derecha">
                    <button type="button" class="btn btn-outline-success" data-bs-toggle="collapse" data-bs-target="#report5">Expandir</button>
                </div>                
        ...
        <section class="report">
            <div class="report-header">
                <h4 class="">Grupos Familiares</h4>
                <div class="derecha">
                    <button type="button" class="btn btn-outline-success" data-bs-toggle="collapse" data-bs-target="#report6">Expandir</button>
                </div>                
            ...
            <div class="report-content collapse" id="report6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="form-report-six" action="/reportes/gruposAmigos">
                            <div class="row">
                                <div class="col-md-3 col-12 mb-2">
                                    ...
                                    <div class="input-group input-daterange" id="datepicker">
                                        ...
                                        <input type="text" class="form-control" name="fecha_inicial" id="fecha_inicial" placeholder="Insertar Fecha Inicial" autocomplete="off">
                                    </div>           
                                    </div>
                                </div>
                                <div class="col-md-3 col-12 mb-2">
                                    ...
                                    <div class="input-group input-daterange" id="datepicker">
                                        ...
                                        <input type="text" class="form-control" name="fecha_final" id="fecha_final" placeholder="Insertar Fecha Final" autocomplete="off">
                                    </div>                                                                               
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 mb-2">
        ...
        <section class="report">
            <div class="report-header">
                <h4 class="">Grupos Familiares</h4>
                <div class="derecha">
                    <button type="button" class="btn btn-outline-success" data-bs-toggle="collapse" data-bs-target="#report7">Expandir</button>
                </div>                
            ...
            <div class="report-content collapse" id="report7">
                <div class="card">
                    <div class="card-header bg-first-color">
                        <h5 class="card-title text-white m-0">Cantidad de grupos familiares ingresados en el mes</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="form-report-seven" action="/reportes/grupos-ingresados-mes">
                            <div class="row">
                                <div class="col-md-3 col-12 mb-2">
                                    <div class="form-group">
                                    <div class="input-group input-daterange" id="datepicker">
                                ...
                                <div class="col-md-4 col-12 mb-2">
                                    <button type="button" name="busqueda_reporte_seven" id="busqueda_reporte_seven" class="btn btn-secondary">
                                        <i class="bi bi-search"></i> Buscar
                                    </button>
                                </div>                                
                            </div>
