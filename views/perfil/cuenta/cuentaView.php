        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="avatar mb-3">
                        ...
                        <a class="pointer editar_perfil" data-number="1" id="avatar-link"><i class="bi bi-pencil"
                                                                                             id="avatar-pencil"></i></a>
                    </div>
                    <h4 class="mb-2">
                        Username
                    ...
                    <div class="show_1 hidden">
                        <input type="text" class="form-control mb-2" value="" id="username" name=""
            ...
            <div class="card-footer bg-transparent">
                ...
                <div class="form-group show_4 hidden">
                    <input type="password" required name="" class="form-control form-input mb-4" id="password"
                           placeholder=" ">
                    <label for="password" class="form-label fw-bold">Contraseña Actual:*</label>
                </div>

                <div class="form-group show_4 hidden">
                    <input type="password" required name="" class="form-control form-input mb-4" id="password-new"
                           placeholder=" ">
                    <label for="password-new" class="form-label fw-bold">Contraseña Nueva:*</label>
                </div>

                <div class="form-group show_4 hidden">
                    <input type="password" required name="" class="form-control form-input mb-4" id="password-confirm"
                           placeholder=" ">
                ...
                <div class="btn-group derecha mb-3" role="group" aria-label="">
                    <button type="submit" name="guardar_cambios" value="Guardar cambios" class="btn btn-success">Guardas
                        cambios
                    </button>
                </div>
            </div>
