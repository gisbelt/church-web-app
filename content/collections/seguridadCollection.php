...
class seguridadCollection
{
    public function formatPermisos($permisos)
    {
        ...
        foreach ($permisos as $permiso) {
            ...
            $permiso['actions'] .= sprintf(
                '<button type="button" data-route="%s" name="eliminar-permiso" id="eliminar-permiso" class="btn btn-danger mx-2"><i class="bi bi-trash text-light"></i>
                          </button>',
    ...
    public function formatRoles($roles)
    {
        ...
        foreach ($roles as $role) {
            ...
            $role['actions'] .= sprintf(
                '<button type="button" data-route="%s" name="eliminar-rol" id="eliminar-rol" class="btn btn-danger mx-2"><i class="bi bi-trash text-light"></i>
                          </button>',
