        ...
        foreach ($miembros as $miembro) {
            ...
            if ($miembro['status'] == 1) {
                if (in_array(permisos::$eliminar_miembros, $_SESSION['user_permisos'])) {
                    $miembro['actions'] .= sprintf(
                        '<button type="button" data-route="%s" name="eliminar-miembro" id="eliminar-miembro" class="btn btn-danger ms-2" data-tile="eliminar"><i class="bi bi-trash text-light"></i>
                          </button>',
